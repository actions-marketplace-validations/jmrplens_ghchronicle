...
de forma queda a un comando de tener unas imágenes que concuerden con él.
`GHC_CARD_THEME` elige `dark`, `light` o `auto`, que mete los dos temas en un
solo fichero detrás de una consulta `prefers-color-scheme`.
