...
![The github-stats layout: a header band, rows of four monospace numbers and a horizontal language share bar with its legend](../../../assets/card-github-stats.svg)
...
![The wide-banner layout: a wide, short banner with the login on the left, numbers spread across and a sparkline behind them](../../../assets/card-wide-banner.svg)
...
![The sparkline-hero layout: a large contribution sparkline filling the card with three numbers overlaid](../../../assets/card-sparkline-hero.svg)
...
![The language-ring layout: a donut chart of language shares with a legend beside it and a row of headline numbers](../../../assets/card-language-ring.svg)
...
![The activity-heatmap layout: twelve weeks of contribution squares in GitHub's green scale with three numbers beside them](../../../assets/card-activity-heatmap.svg)
...
![The animated-counters layout: a grid of large numbers over a contribution sparkline](../../../assets/card-animated-counters.svg)
