...
What one pass over GitHub does, in what order, and why each family has its own cadence.
...
flowchart TD
    ...
    B -- "yes" --> C["Collect"]
    C --> P["Dated points"]
    P --> H["Destinations that keep the date<br/>InfluxDB, file, stdout, Telegraf, Graphite,<br/>PostgreSQL, Elasticsearch"]
